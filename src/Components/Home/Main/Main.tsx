...
const Main: React.FC = (): JSX.Element => {
  return (
    <div className='main'>
      ...
      <div className='row'>
        <h1 className='col-5 mx-auto fw-bold text-center'>
          Let's growth your business with us
        </h1>
      </div>
      <div className='row'>
        <p className='mx-auto fw-normal text-center' style={{ width: '48%', fontFamily: 'Open Sans', color: '#CCE6E3', lineHeight: '1.8rem' }}>
      ...
      <div className='highlights row'>
        <div className='row col-md-4'>
          <div className='col-3'><i className="fa-solid fa-layer-group fa-2x"></i></div>
          <div className='col-9'>
