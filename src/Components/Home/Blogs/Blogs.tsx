...
const Blogs: React.FC = (): JSX.Element => {
  return (
    <div style={{ color: 'black', padding: '110px 0' }}>
      ...
      <div className='bottom row mx-auto align-center w-100' style={{ padding: '0 80px' }}>

        <div className='col-4 '>
          <img src='images/post_1.jpg' width='100%' style={{ borderRadius: '10px' }} />
          <div style={{ margin: '15px' }} >
            <p style={{ fontFamily: 'Open Sans', fontSize: 'small', color: 'gray' }}>May 27, 2021 • 12 Comments</p>
            <h5 style={{ fontWeight: '700' }} >Importance of getting a notification</h5>
            <p style={{ fontFamily: 'Open Sans', fontSize: 'small', lineHeight: '2' }} >
              Sapiente, assumenda suscipit autem ab expedita dignissimos, corrupti iusto nobis ex aperiam cumque reprehenderit consequuntur.
            </p>
            <a style={{ fontFamily: 'Open Sans', fontSize: 'small', color: '#F86952' }} >Read more &gt;</a>
          </div>
        </div>

        <div className='col-4'>
          <img src='images/post_2.jpg' width='100%' style={{ borderRadius: '10px' }} />
          <div style={{ margin: '15px' }} >
            <p style={{ fontFamily: 'Open Sans', fontSize: 'small', color: 'gray' }}>May 27, 2021 • 12 Comments</p>
            <h5 style={{ fontWeight: '700' }} >Importance of getting a notification</h5>
            <p style={{ fontFamily: 'Open Sans', fontSize: 'small', lineHeight: '2' }} >
        ...
        <div className='col-4'>
          <img src='images/post_3.jpg' width='100%' style={{ borderRadius: '10px' }} />
          <div style={{ margin: '15px' }} >
            <p style={{ fontFamily: 'Open Sans', fontSize: 'small', color: 'gray' }}>May 27, 2021 • 12 Comments</p>
            <h5 style={{ fontWeight: '700' }} >Importance of getting a notification</h5>
            <p style={{ fontFamily: 'Open Sans', fontSize: 'small', lineHeight: '2' }} >
